                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                       {transportOptions.map((opt) => (
                          <button
                             ...
                             className={`group relative h-24 border flex flex-col items-center justify-center gap-3 transition-all duration-500 ${
                                transportMode === opt.id ? "bg-brand-red border-brand-red" : "bg-white border-black/20 hover:border-brand-dark"
