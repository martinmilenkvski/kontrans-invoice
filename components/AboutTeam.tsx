      ...
      <div className="max-w-[1600px] mx-auto px-4 lg:px-4">
        ...
        <div className="mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
            <div className="max-w-4xl">
               <span className="team-header-reveal font-mono text-[11px] font-medium tracking-[0.4em] text-[#D42B2B] mb-6 block uppercase">007 // Team & vision</span>
               <h2 className="team-header-reveal font-sans text-[clamp(2.5rem,7vw,5.5rem)] font-medium text-[#111111] leading-[0.8] tracking-tighter mb-2">
            ...
            <div className="hidden lg:flex flex-col items-end gap-4 text-right">
               ...
               <p className="team-header-reveal font-[family-name:var(--font-jost)] text-sm text-black/60 max-w-[280px] leading-relaxed">
        ...
        <div className="team-grid-trigger grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-24 items-start mb-32">
            ...
            <div className="md:col-span-3">
               <div className="team-grid-reveal bg-[#D42B2B] p-6 lg:p-8 relative overflow-hidden group h-full shadow-2xl">
                  {/* Decorative Scanline */}
            ...
            <div className="md:col-span-3 flex flex-col gap-12">
               <p className="team-grid-reveal text-[#111111]/70 font-normal text-lg leading-relaxed">
               ...
               <div className="team-grid-reveal flex items-center gap-6 p-8 border border-black/5 bg-white hover:border-[#D42B2B] transition-colors group shadow-lg">
